...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse d-flex flex-row-reverse bd-highlight" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <button class="btn btn-outline-primary margin-right" id="cartBtn" >
    ...
    <button class="btn btn-primary btn-width margin-left" id="clearBtn">Clear</button>
    <div class="margin-left row">
      <div class="col-md-9">
        ...
        <div class="col-md-3 ms-auto"> <!-- Используем класс ms-auto для выравнивания карточки по правому краю -->
          <div class="card" >
              <div class="card-body">
                  <h5 class="card-title">Making an order</h5>
                  <form id="feedbackForm">
                      <div class="mb-3">
                          <label for="name" class="form-label">Name and Last Name</label>
                          <input type="text" class="form-control max-width-small" id="name">
                      </div>
                      <div class="mb-3">
                          <label for="email" class="form-label">email</label>
                          <input type="text" class="form-control max-width-small" id="email">
                      </div>
                      <div class="mb-3">
                          <label for="phone" class="form-label ">Phone number</label>
                          <input type="text" class="form-control max-width-small" id="phone">
                      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- Сюда будет выводиться сообщение -->
          </div>
